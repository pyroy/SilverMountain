class module_master:
    ...
    def setup(self, game_main, MODULES): pass;  
    ...
    def make_scaled_graphics(self, game_main, MODULES, visual_core, canvas_unscaled): pass;
    def make_graphics(self, game_main, MODULES, visual_core): pass;
    def run_frame(self, game_main, MODULES): pass;